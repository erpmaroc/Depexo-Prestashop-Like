...
# join the Depexo logger
import logging

log = logging.getLogger('depexo')
...
def update_meta_data(meta=None):
    ...
    if 'PROGRAM' not in meta:
        meta['PROGRAM'] = "depexoTools.catalogs"
...
def save_catalog(filename, catalog, meta=None, prefix=None):
    ...
    - base_comp.ext :class:`depexoTools.models.ComponentSource`
    - base_isle.ext :class:`depexoTools.models.IslandSource`
    - base_simp.ext :class:`depexoTools.models.SimpleSource`
    ...
    catalog : list
        A list of sources to write. Sources must be of type :class:`depexoTools.models.ComponentSource`,
        :class:`depexoTools.models.SimpleSource`, or :class:`depexoTools.models.IslandSource`.
...
def table_to_source_list(table, src_type=ComponentSource):
    ...
    :class:`depexoTools.models.ComponentSource`, :class:`depexoTools.models.SimpleSource`,
    or :class:`depexoTools.models.IslandSource`.
    ...
    src_type : class
        Sources must be of type :class:`depexoTools.models.ComponentSource`,
        :class:`depexoTools.models.SimpleSource`, or :class:`depexoTools.models.IslandSource`.
...
def write_catalog(filename, catalog, fmt=None, meta=None, prefix=None):
    ...
    catalog : list
        A list of source objects. Sources must be of type :class:`depexoTools.models.ComponentSource`,
        :class:`depexoTools.models.SimpleSource`, or :class:`depexoTools.models.IslandSource`.
...
def writeIslandContours(filename, catalog, fmt='reg'):
    ...
    catalog : list
        List of sources. Only those of type :class:`depexoTools.models.IslandSource` will have contours drawn.
    ...
    See Also
    --------
    :func:`depexoTools.catalogs.writeIslandBoxes`
    """
    if fmt != 'reg':
    ...
    out = open(filename, 'w')
    print("#Depexo island contours", file=out)
    print("#depexoTools.catalogs version {0}-({1})".format(__version__, __date__), file=out)
...
def writeIslandBoxes(filename, catalog, fmt):
    ...
    See Also
    --------
    :func:`depexoTools.catalogs.writeIslandContours`
    """
    ...
    out = open(filename, 'w')
    print("#Depexo Islands", file=out)
    print("#Depexo version {0}-({1})".format(__version__, __date__), file=out)
...
def writeAnn(filename, catalog, fmt):
    ...
    Only :class:`depexoTools.models.ComponentSource` will appear in the annotation file
    unless there are none, in which case :class:`depexoTools.models.SimpleSource` (if present)
    will be written. If any :class:`depexoTools.models.IslandSource` objects are present then
    ...
    See Also
    --------
    depexoTools.catalogs.writeIslandContours
    """
    if fmt not in ['reg', 'ann']:
        log.warning("Format not supported for island boxes{0}".format(fmt))
        return  # fmt not supported
...
def writeDB(filename, catalog, meta=None):
    ...
    catalog : list
        List of sources of type :class:`depexoTools.models.ComponentSource`,
        :class:`depexoTools.models.SimpleSource`, or :class:`depexoTools.models.IslandSource`.
