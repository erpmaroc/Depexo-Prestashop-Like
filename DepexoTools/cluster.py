...
def sky_dist(src1, src2):
    ...
    See Also
    --------
    :func:`depexoTools.angle_tools.gcd`
    """
...
def pairwise_ellpitical_binary(sources, eps, far=None):
    ...
    See Also
    --------
    :func:`depexoTools.cluster.norm_dist`
    """
    if far is None:
...
def regroup_vectorized(srccat, eps, far=None, dist=norm_dist):
    ...
    dist : func
        ...
        Default = :func:`depexoTools.cluster.norm_dist`
...
def resize(catalog, ratio=None, psfhelper=None):
    ...
    psfhelper : :py:class:`depexoTools.wcs_helpers.WCSHelper`, default=None
...
def check_attributes_for_regroup(catalog):
    ...
    ----------
    catalog : list
        List of python objects, ideally derived from :py:class:`depexoTools.models.SimpleSource`
