#! /usr/bin/env python
"""
Different types of sources that Depexo is able to fit
...
class SimpleSource(object):
    ...
    flags : int
        Flags. See :mod:`depexoTools.flags`.
...
class ComponentSource(SimpleSource):
    """
    A Gaussian component, aka a source, that was measured by Depexo.
...
class GlobalFittingData(object):
    ...
    Attributes
    ----------
    img : :class:`depexoTools.fits_image.FitsImage`
    ...
    beam : :class:`depexoTools.wcs_helpers.Beam`
    ...
    region : :class:`depexoTools.regions.Region`
        The region that will be used to limit the source finding of Depexo.
...
def island_itergen(catalog):
    ...
    ----------
    catalog : iterable
        A list or iterable of :class:`depexoTools.models.ComponentSource` objects.
