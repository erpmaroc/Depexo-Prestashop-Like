...
class Region(object):
    ...
    def load(cls, mimfile):
        ...
        Returns
        -------
        region : `depexoTools.regions.Region`
            A region object
        """
    ...
    def union(self, other, renorm=True):
        ...
        Parameters
        ----------
        other : :class:`depexoTools.regions.Region`
    ...
    def sky2ang(sky):
        ...
        sky : numpy.array
            Array of (ra,dec) coordinates.
            See :func:`depexoTools.regions.Region.radec2sky`
    ...
    def sky2vec(cls, sky):
        ...
        See Also
        --------
        :func:`depexoTools.regions.Region.vec2sky`
        """
    ...
    def vec2sky(cls, vec, degrees=False):
        ...
        See Also
        --------
        :func:`depexoTools.regions.Region.sky2vec`
        """
