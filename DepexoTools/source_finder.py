#! /usr/bin/env python
"""
The Depexo source finding program.
"""
...
from depexoTools.wcs_helpers import Beam
...
def find_islands(im, bkg, rms, seed_clip=5.0, flood_clip=4.0, log=log):
    ...
    Returns
    -------
    islands : [:class:`depexoTools.models.PixelIsland`, ...]
      a list of islands
    """
    # compute SNR image
    snr = abs(im - bkg) / rms
...
def fit_islands_parinfo(models, im, rms, wcshelper):
    ...
    wcshelper : :class:`depexoTools.wcs_helpers.WCSHelper`
      A wcs object valid for the image map

    Returns
    -------
    islands : [depexoTools.models.SimpleSource, ...]
      a list of islands
    """
...
def priorized_islands_parinfo(sources, im, wcshelper, stage=3):
    ...
    Parameters
    ----------
    sources : [depexoTools.models.SimpleSource, ... ]
      A list of sources in the catalogue.
    ...
    Returns
    -------
    islands : [:class:`depexoTools.models.ComponentSource`, ...]
...
def characterise_islands(
    ...
    Returns
    -------
    sources : [:py:class:`depexoTools.models.SimpleSource`, ... ]
      A list of characterised sources of type
      :py:class:`depexoTools.models.impleSource`,
      :py:class:`depexoTools.models.ComponentSource`,
      or :py:class:`depexoTools.models.IslandSource`.
    """
...
class SourceFinder(object):
    """
    The Depexo source finding algorithm

    Attributes
    ----------
    global_data : :class:`depexoTools.models.GlobalFittingData`
    ...
    def estimate_lmfit_parinfo(
        ...
        beam : :class:`depexoTools.fits_image.Beam`
    ...
    def result_to_components(self, result, model, island_data, isflags):
        ...
        island_data : :class:`depexoTools.models.IslandFittingData`
    ...
    def load_globals(
        ...
        mask : str or :class:`depexoTools.regions.Region`
        ...
        debug = logging.getLogger("depexo").isEnabledFor(logging.DEBUG)
    ...
    def save_background_files(
        ...
        They are saved in the current directly as depexo-background.fits
        and depexo-rms.fits.
        ...
        new_hdu = img.hdu
        # Set the ORIGIN to indicate Depexo made this file
        new_hdu.header["ORIGIN"] = "Depexo {0}-({1})".format(
    ...
    def save_image(self, outname):
        ...
        hdu.header["ORIGIN"] = "Depexo {0}-({1})".format(__version__, __date__)
    ...
    def _load_aux_image(self, image, auxfile):
        ...
        Parameters
        ----------
        image : :class:`depexoTools.fits_image.FitsImage`
        ...
        Returns
        -------
        aux : :class:`depexoTools.fits_image.FitsImage`
          The loaded image.
        """
    ...
    def _fit_islands(self, islands):
        ...
        Parameters
        ----------
        islands : list of :class:`depexoTools.models.IslandFittingData`
    ...
    def priorized_fit_islands(
        ...
        from depexoTools.cluster import regroup_dbscan
