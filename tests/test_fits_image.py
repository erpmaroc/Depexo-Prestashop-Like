...
import depexoTools.wcs_helpers
from depexoTools import fits_image as fi
...
def test_get_pixinfo():
    ...
    area, scale = depexoTools.wcs_helpers.get_pixinfo(header)
...
def test_get_beam():
    ...
    header = fits.getheader('tests/test_files/1904-66_SIN.fits')
    beam = depexoTools.wcs_helpers.get_beam(header)
    print(beam)
...
def test_fix_aips_header():
    ...
    _ = depexoTools.wcs_helpers.fix_aips_header(header)
...
def test_init():
    ...
    beam = depexoTools.wcs_helpers.Beam(1, 1, 0)
