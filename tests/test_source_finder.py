...
from depexoTools import source_finder as sf
from depexoTools.wcs_helpers import Beam, WCSHelper
from depexoTools import models, flags
from depexoTools.models import classify_catalog
...
def dont_test_load_globals():
    ...
    sfinder = sf.SourceFinder(log=log)
    aux_files = sf.get_aux_files('tests/test_files/1904-66_SIN.fits')
    from depexoTools.regions import Region
